...
import "./ProjectDetailsPagePeople.css";
import { ThemeContext } from "../../contexts/ThemeContext";
import { headerData } from "../../data/headerData";

function ProjectDetailsPagePeople() {
  ...
  const [selectedImage, setSelectedImage] = useState(null);
    ...
    return (
      <div className="ProjectDetailsPagePeople" style={{ backgroundColor: theme.secondary }}>
        <Helmet>
          <title>{headerData.name} | People</title>
        </Helmet>
        <div
          className="ProjectDetailsPagePeople-header"
          style={{ backgroundColor: theme.primary }}
        >
          <Link to="/">
            <AiOutlineHome className={classes.home} />
          </Link>
          <h1 style={{ color: theme.secondary }}>People</h1>
        </div>
        <div className="ProjectDetailsPagePeople-container">
          {/* <div className="ProjectDetailsPagePeople-search">
            <input
              type="text"
              value={search}
...
export default ProjectDetailsPagePeople;