...
function ProjectDetailsPageDesign() {
  ...
  const [selectedImage, setSelectedImage] = useState(null);
    ...
    return (
      <div className="ProjectDetailsPageDesign" style={{ backgroundColor: theme.secondary }}>
        <Helmet>
          <title>{headerData.name} | Design</title>
        </Helmet>
        <div
          className="ProjectDetailsPageDesign-header"
          style={{ backgroundColor: theme.primary }}
        >
          <Link to="/">
            <AiOutlineHome className={classes.home} />
          </Link>
          <h1 style={{ color: theme.secondary }}>Design</h1>
        </div>
        <div className="ProjectDetailsPageDesign-container">
          {/* <div className="ProjectDetailsPageDesign-search">
            <input
              type="text"
              value={search}
...
export default ProjectDetailsPageDesign;